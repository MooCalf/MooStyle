...
const SECTION_TITLES = [
  ...
  'REFUNDS POLICY',
  'PARTNERSHIPS AND MOD SUBMISSIONS',
  'SOFTWARE',
...
const buildPages = (jumpTo) => [
  {
    title: 'Agreement to Our Legal Terms',
    body: (
      <>
        <p>
          We are <strong>MOOSTYLES</strong> ("Company," "we," "us," "our"), a company registered in Jamaica. We operate the website <a href="https://moostyles.com" target="_blank" rel="noopener noreferrer">https://moostyles.com</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
        </p>
        <p>
          You can contact us by email at <a href="mailto:hello@moostyles.com">hello@moostyles.com</a>.
        </p>
        <p>
        ...
        <p>
          The Services may also contain content intended for users 18 years of age or older. Where that's the case, it will be labeled accordingly, and you should not access it if you are under 18 or if viewing such content is not legal where you live.
        </p>
  ...
  },
  {
    ...
    body: (
      <ul className="legal-pager__toc">
        {SECTION_TITLES.map((title, i) => (
          <li key={title}>
            <button type="button" className="legal-pager__toc-link" onClick={() => jumpTo(i + 2)}>
              {i + 1}. {title}
            </button>
          </li>
        ))}
  ...
  {
    title: '5. DONATIONS AND PAYMENT',
    body: (
      <>
        <p>We accept donations through the following platforms:</p>
        <ul>
          <li>Patreon</li>
          <li>PayPal</li>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>
          <strong>Dispute Resolution:</strong> If you have concerns about a transaction, please contact us at <a href="mailto:hello@moostyles.com">hello@moostyles.com</a> to discuss the matter before initiating any chargeback or dispute with your payment provider.
        </p>
      </>
    ),
  },
  {
    title: '7. PARTNERSHIPS AND MOD SUBMISSIONS',
    body: (
      <>
        <p>
        ...
        <p><strong>Mod Submission Guidelines:</strong> All submitted mods must:</p>
        <ul>
  ...
  {
    title: '11. USER GENERATED CONTRIBUTIONS',
    body: (
      <>
        <p>
  ...
  },
  {
    ...
    body: (
      <>
        <p>
          We care about data privacy and security. Please review our Privacy Policy: <a href="https://moostyles.com/privacy-policy" target="_blank" rel="noopener noreferrer">https://moostyles.com/privacy-policy</a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.
        </p>
        <p>
    ...
    body: (
      <>
        ...
        <p>
          ...
          <a href="mailto:hello@moostyles.com">hello@moostyles.com</a>
        </p>
      </>
    ),
  },
...
export const TermsOfService = () => {
  ...
  const pages = useMemo(() => buildPages(setIndex), []);
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <h1 className="mod-detail__title newdesign-heading newdesign-brand-label">Terms of Service</h1>
        <p className="legal-page__meta"><strong>Last updated:</strong> October 17, 2025</p>

        <LegalPager pages={pages} index={index} onIndexChange={setIndex} />
      </main>
