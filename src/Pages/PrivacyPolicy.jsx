    ...
    body: (
      <>
        ...
        <ul>
          ...
          <li><p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to MOOSTYLES.</p></li>
          ...
          <li><p><strong>Website</strong> refers to MOOSTYLES, accessible from <a href="https://moostyles.com" rel="external nofollow noopener" target="_blank">https://moostyles.com</a></p></li>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <ul>
          <li><p><strong>To provide and maintain our Service</strong>, including to monitor the usage of our Service and provide access to gaming mods and content.</p></li>
          <li><p><strong>To process donations and payments:</strong> When you make donations through Patreon or our future donation system, we collect and process payment information to complete transactions and maintain donation records.</p></li>
          <li><p><strong>To manage partnerships:</strong> We collect contact information and mod submission data from partners who wish to list their mods on our platform, including communication records and partnership agreements.</p></li>
          <li><p><strong>To provide advertising services:</strong> We use data to display relevant advertisements through Google AdSense and other advertising networks, including tracking user interactions with ads.</p></li>
          <li><p><strong>To contact You:</strong> To contact You by email regarding mod updates, partnership opportunities, donation confirmations, or other service-related communications.</p></li>
          <li><p><strong>To manage Your requests:</strong> To attend and manage Your requests to Us, including support inquiries, mod submissions, and partnership applications.</p></li>
      ...
      <>
        ...
        <ul>
          ...
          <li>
            ...
            <p>For donation processing. Their Privacy Policy can be viewed at <a href="https://www.patreon.com/privacy" rel="external nofollow noopener" target="_blank">https://www.patreon.com/privacy</a></p>
          </li>
          <li>
            <p><strong>Google AdSense</strong></p>
            <p>For advertising services. Their Privacy Policy can be viewed at <a href="https://policies.google.com/privacy" rel="external nofollow noopener" target="_blank">https://policies.google.com/privacy</a></p>
          </li>
          <li>
            <p><strong>PayPal</strong></p>
            <p>For payment processing. Their Privacy Policy can be viewed at <a href="https://www.paypal.com/us/webapps/mpp/ua/privacy-full" rel="external nofollow noopener" target="_blank">https://www.paypal.com/us/webapps/mpp/ua/privacy-full</a></p>
          </li>
        </ul>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        <p>
          Separately, some content available through the Service may not be suitable for individuals under the age of 18. Such content is not directed at minors, and by using the Service you confirm that you meet the applicable age requirements in Your jurisdiction to view it.
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <ul>
          <li>By visiting this page on our website: <a href="https://moostyles.com/support" rel="external nofollow noopener" target="_blank">https://moostyles.com/support</a></li>
        </ul>
      </>
    ),
  },
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <h1 className="mod-detail__title newdesign-heading newdesign-brand-label">Privacy Policy</h1>
